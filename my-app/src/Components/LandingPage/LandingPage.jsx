          ...
          <div className={styles["info__content-container"]}>
            <div className={styles["info-left"]}>
              <p className={styles["info-left__text"]}>
                “A camera alone does not make a picture. <br />To make a picture
                you need a camera, a photographer and above all a subject. It is
                the subject that determines the interest of the photograph.”<br />
                <span className={styles["info-left__text--span"]}> – Man Ray</span>
              </p>
            ...
            <div className={styles["info-right"]}>
              <img src="../public/images/img-info.jpg" className={styles["info-right__img"]} />
            </div>
          </div>
        </div>
      </main>
